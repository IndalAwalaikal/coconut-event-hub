...
const AdminDashboard = () => {
  ...
  // Fetch registrants for all events
  useEffect(() => {
  ...
  // Get recent 5 registrants sorted by registration date
            ...
            {events.slice(0, 5).map((event, idx) => (
              ...
              >
                <div className="flex items-center gap-4 flex-1 min-w-0">
                  {/* Event Icon */}
                  <div className="flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-[#3b82f6] to-[#2563eb] text-white shadow-lg group-hover:scale-110 transition-transform duration-300">
                  ...
                  <div className="flex-1 min-w-0 mr-4">
                    <p
                      className="font-semibold text-gray-900 truncate group-hover:text-[#2563eb] transition-colors"
                      title={event.title}
                    >
                      {event.title}
                    </p>
                    <div className="flex items-center gap-2 mt-1 flex-wrap">
                      <span className="text-xs font-medium text-[#2563eb] bg-[#3b82f6]/10 px-2 py-0.5 rounded-full whitespace-nowrap">
                        {event.categoryLabel}
                      </span>
        ...
        <div className="overflow-x-auto">
          {recentRegistrants.length > 0 ? (
            ...
            <div className="flex flex-col items-center justify-center py-12">
              ...
              <p className="font-semibold text-gray-900">Belum ada pendaftar</p>
              <p className="text-sm text-gray-500 mt-1">
